# Generated by Django 3.2.12 on 2025-11-19 08:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pincode', models.CharField(db_index=True, help_text='6-digit pincode', max_length=6, validators=[ujjwala_v3.validators.validate_pincode, django.core.validators.MinLengthValidator(6), django.core.validators.MaxLengthValidator(6)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('applicant_full_name', models.CharField(db_index=True, help_text='Full name of applicant as per Aadhaar', max_length=200, validators=[ujjwala_v3.validators.validate_name])),
                ('applicant_first_name', models.CharField(help_text='First name of applicant', max_length=100, validators=[ujjwala_v3.validators.validate_name])),
                ('applicant_middle_name', models.CharField(blank=True, help_text='Middle name of applicant (optional)', max_length=100, null=True, validators=[ujjwala_v3.validators.validate_name])),
                ('applicant_last_name', models.CharField(blank=True, help_text='Last name of applicant (optional)', max_length=100, null=True, validators=[ujjwala_v3.validators.validate_name])),
                ...
                ('applicant_dob', models.DateField(db_index=True, help_text='Date of birth as per Aadhaar (Must be >= 18 years)', validators=[ujjwala_v3.validators.validate_adult_dob, ujjwala_v3.validators.validate_future_date])),
                ('applicant_aadhaar_number', models.CharField(db_index=True, help_text='12-digit Aadhaar number (unique)', max_length=12, unique=True, validators=[ujjwala_v3.validators.validate_aadhaar_number, django.core.validators.MinLengthValidator(12), django.core.validators.MaxLengthValidator(12)])),
                ('applicant_mobile', models.CharField(db_index=True, help_text='10-digit mobile number', max_length=10, validators=[ujjwala_v3.validators.validate_mobile_number, django.core.validators.MinLengthValidator(10), django.core.validators.MaxLengthValidator(10)])),
                ...
                ('marital_status', models.CharField(choices=[('MARRIED', 'Married'), ('UNMARRIED', 'Unmarried'), ('DIVORCED', 'Divorced'), ('WIDOWED', 'Widowed'), ('SEPARATED', 'Separated')], default='MARRIED', help_text='Marital status of the applicant', max_length=25)),
                ('marriage_date', models.DateField(blank=True, help_text='Date of marriage (if applicable)', null=True)),
                ('ekyc_date', models.DateTimeField(blank=True, help_text='Date and time when eKYC was performed', null=True)),
                ('ekyc_channel', models.CharField(blank=True, help_text='Channel through which eKYC was performed (e.g., Aadhaar, DigiLocker)', max_length=128, null=True)),
                ('ekyc_last_attempt_log', models.TextField(blank=True, help_text='Log of the last eKYC attempt (error messages, responses)', null=True)),
                ('ekyc_cleared', models.BooleanField(default=False, help_text='Whether eKYC verification has been cleared/passed')),
                ('robo_execution_failed_count', models.IntegerField(blank=True, default=0, help_text='Count of failed robotic process automation attempts', null=True)),
                ('latitude', models.CharField(blank=True, help_text='Latitude coordinate for application location', max_length=32, null=True)),
                ('longitude', models.CharField(blank=True, help_text='Longitude coordinate for application location', max_length=32, null=True)),
                ('accuracy', models.CharField(blank=True, help_text='GPS accuracy of the location coordinates', max_length=24, null=True)),
                ('version', models.CharField(default='V3', help_text='Version of the Ujjwala application (V2, V3)', max_length=2)),
                ...
                ('bank_account_name', models.CharField(help_text='Account holder name as per bank records', max_length=200, validators=[ujjwala_v3.validators.validate_name])),
                ...
                ('bank_ifsc', models.CharField(db_index=True, help_text='11-character IFSC code', max_length=11, validators=[ujjwala_v3.validators.validate_ifsc_code, django.core.validators.MinLengthValidator(11), django.core.validators.MaxLengthValidator(11)])),
                ('bank_account_number', models.CharField(help_text='Bank account number (9-18 characters)', max_length=18, validators=[ujjwala_v3.validators.validate_bank_account_number])),
                ...
                ('tags', taggit.managers.TaggableManager(blank=True, help_text='Tags for categorization and filtering', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('full_name', models.CharField(help_text='Full name as per Aadhaar', max_length=200, validators=[ujjwala_v3.validators.validate_name])),
                ...
                ('aadhaar_number', models.CharField(db_index=True, help_text='12-digit Aadhaar number', max_length=12, validators=[ujjwala_v3.validators.validate_aadhaar_number, django.core.validators.MinLengthValidator(12), django.core.validators.MaxLengthValidator(12)])),
                ('dob', models.DateField(help_text='Date of birth as per Aadhaar', validators=[ujjwala_v3.validators.validate_future_date])),
        ...
        migrations.AddField(
            ...
            name='application',
            field=models.ForeignKey(help_text='Related application', on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to='ujjwala_v3.ujjwalav3application'),
        ),
        migrations.AddIndex(
