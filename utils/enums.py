...
class UidMobileStatusEnum(models.TextChoices):
...
class DomesticConnectionApplicationStatus(models.TextChoices):
...
class OmcClearedCustomerRemarksEnum(models.TextChoices):
