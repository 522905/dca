# Generated by Django 3.2.12 on 2022-08-13 12:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('teams', '0004_auto_20220813_1157'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='servicearea',
            options={'ordering': ['tn_order'], 'verbose_name': 'Service Area', 'verbose_name_plural': 'Service Areas'},
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='servicearea',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='teams.servicearea', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='servicearea',
            name='tn_priority',
