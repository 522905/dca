    ...
    def get(self, request, *args, **kwargs):
        ...
        if connection_disbursement:
            ...
            return render(
                ...
                {
                    "heading": "Legal Documents",
                    "message": "Application Id {} not valid state. Connection Disbursement not created.".format(
                        kwargs.get('pk'))
                }
            )
...
class ChangeCylinderTypeView(FormView):
    ...
    def form_valid(self, form):
        ...
        django_rq.enqueue(
            ...
            args=(
                get_current_user().id, obj.id,
                data.get('new_phone_number') if data.get('change_phone_number') else obj.contact_mobile,
            )
        )
        messages.add_message(self.request, messages.INFO,
...
class CamundaChangeAddressView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            "obj": obj,
            "old_address_json": self.variables['old_address_json'] if self.kwargs.get(
    ...
    def form_valid(self, form):
        ...
        res = requests.post(url, json={
            ...
            "processVariables": {
                "old_address_json": {"value": json.dumps(self.variables.get('address_json').get('value')),
                                     "type": "String"},
